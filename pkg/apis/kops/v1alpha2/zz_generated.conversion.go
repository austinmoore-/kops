...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*DockerSource)(nil), (*kops.DockerSource)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_DockerSource_To_kops_DockerSource(a.(*DockerSource), b.(*kops.DockerSource), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.DockerSource)(nil), (*DockerSource)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_DockerSource_To_v1alpha2_DockerSource(a.(*kops.DockerSource), b.(*DockerSource), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*ExtraPackage)(nil), (*kops.ExtraPackage)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_ExtraPackage_To_kops_ExtraPackage(a.(*ExtraPackage), b.(*kops.ExtraPackage), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.ExtraPackage)(nil), (*ExtraPackage)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_ExtraPackage_To_v1alpha2_ExtraPackage(a.(*kops.ExtraPackage), b.(*ExtraPackage), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_DockerConfig_To_kops_DockerConfig(in *DockerConfig, out *kops.DockerConfig, s conversion.Scope) error {
	...
	if in.SourceOverrides != nil {
		...
		*out = make([]kops.DockerSource, len(*in))
		for i := range *in {
			if err := Convert_v1alpha2_DockerSource_To_kops_DockerSource(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
		out.SourceOverrides = nil
	}
...
func autoConvert_kops_DockerConfig_To_v1alpha2_DockerConfig(in *kops.DockerConfig, out *DockerConfig, s conversion.Scope) error {
	...
	if in.SourceOverrides != nil {
		in, out := &in.SourceOverrides, &out.SourceOverrides
		*out = make([]DockerSource, len(*in))
		for i := range *in {
			if err := Convert_kops_DockerSource_To_v1alpha2_DockerSource(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1alpha2_DockerSource_To_kops_DockerSource(in *DockerSource, out *kops.DockerSource, s conversion.Scope) error {
	out.Name = in.Name
	out.Version = in.Version
	...
	if in.ExtraPackages != nil {
		...
		*out = make([]kops.ExtraPackage, len(*in))
		for i := range *in {
			if err := Convert_v1alpha2_ExtraPackage_To_kops_ExtraPackage(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
		out.ExtraPackages = nil
	}
	out.Dependencies = in.Dependencies
	out.PlainBinary = in.PlainBinary
	out.MarkImmutable = in.MarkImmutable
	return nil
}

// Convert_v1alpha2_DockerSource_To_kops_DockerSource is an autogenerated conversion function.
func Convert_v1alpha2_DockerSource_To_kops_DockerSource(in *DockerSource, out *kops.DockerSource, s conversion.Scope) error {
	return autoConvert_v1alpha2_DockerSource_To_kops_DockerSource(in, out, s)
}

func autoConvert_kops_DockerSource_To_v1alpha2_DockerSource(in *kops.DockerSource, out *DockerSource, s conversion.Scope) error {
	out.Name = in.Name
	out.Version = in.Version
	out.Source = in.Source
	out.Hash = in.Hash
	if in.ExtraPackages != nil {
		in, out := &in.ExtraPackages, &out.ExtraPackages
		*out = make([]ExtraPackage, len(*in))
		for i := range *in {
			if err := Convert_kops_ExtraPackage_To_v1alpha2_ExtraPackage(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
// Convert_kops_DockerSource_To_v1alpha2_DockerSource is an autogenerated conversion function.
func Convert_kops_DockerSource_To_v1alpha2_DockerSource(in *kops.DockerSource, out *DockerSource, s conversion.Scope) error {
	return autoConvert_kops_DockerSource_To_v1alpha2_DockerSource(in, out, s)
}
...
func autoConvert_v1alpha2_ExtraPackage_To_kops_ExtraPackage(in *ExtraPackage, out *kops.ExtraPackage, s conversion.Scope) error {
	out.Name = in.Name
	out.Version = in.Version
	out.Source = in.Source
	out.Hash = in.Hash
...
// Convert_v1alpha2_ExtraPackage_To_kops_ExtraPackage is an autogenerated conversion function.
func Convert_v1alpha2_ExtraPackage_To_kops_ExtraPackage(in *ExtraPackage, out *kops.ExtraPackage, s conversion.Scope) error {
	return autoConvert_v1alpha2_ExtraPackage_To_kops_ExtraPackage(in, out, s)
}

func autoConvert_kops_ExtraPackage_To_v1alpha2_ExtraPackage(in *kops.ExtraPackage, out *ExtraPackage, s conversion.Scope) error {
	out.Name = in.Name
	out.Version = in.Version
	out.Source = in.Source
	out.Hash = in.Hash
...
// Convert_kops_ExtraPackage_To_v1alpha2_ExtraPackage is an autogenerated conversion function.
func Convert_kops_ExtraPackage_To_v1alpha2_ExtraPackage(in *kops.ExtraPackage, out *ExtraPackage, s conversion.Scope) error {
	return autoConvert_kops_ExtraPackage_To_v1alpha2_ExtraPackage(in, out, s)
}
