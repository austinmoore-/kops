...
func (in *DockerSource) DeepCopyInto(out *DockerSource) {
	*out = *in
	...
	if in.MarkImmutable != nil {
		in, out := &in.MarkImmutable, &out.MarkImmutable
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExtraPackage) DeepCopyInto(out *ExtraPackage) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExtraPackage.
func (in *ExtraPackage) DeepCopy() *ExtraPackage {
	if in == nil {
		return nil
	}
	out := new(ExtraPackage)
	in.DeepCopyInto(out)
	return out
}
